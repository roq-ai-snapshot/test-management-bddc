...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Issues', path: '/issues', entity: 'issue', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Projects', path: '/projects', entity: 'project', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Tasks', path: '/tasks', entity: 'task', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Test Cases', path: '/test-cases', entity: 'test_case', service: AccessServiceEnum.PROJECT, icon: FiBox },
