  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Elevate Your Development Process with Test Management Tool: Streamlining, Simplifying, and Enhancing Your Testing Efforts for Unmatched Efficiency"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1532622785990-d2c36a76f5a6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkZXZlbG9wbWVudHxlbnwwfHx8fDE2OTQ4ODI5MDZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Elevate Your Development Process with Test Management Tool: Streamlining, Simplifying, and Enhancing Your Testing Efforts for Unmatched Efficiency`}
            </Text>
            <Box
